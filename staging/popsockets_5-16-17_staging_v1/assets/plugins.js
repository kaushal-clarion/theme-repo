...
(function(factory) {
    ...
    Slick.prototype.setSlideClasses = function(index) {
      ...
      // for Current slide
      _.$slider.find('.slick-slide').removeClass('nextS');
      _.$slider.find('.slick-slide').removeClass('prevS');
        ...
        if (_.options.centerMode === true) {
            ...
            if (index >= centerOffset && index <= (_.slideCount - 1) - centerOffset) {
              ...
              // for Current slide
     $('.slick-active').last().next().addClass('nextS');
     $('.slick-active').first().prev().addClass('prevS');
            } else {
